...
public partial class TnTMeasurements
{
    ...
    private const string NtScrollbarStyles =
        ".nt-scrollbar{scrollbar-color:var(--tnt-color-primary-fixed) transparent;scrollbar-gutter:auto;scrollbar-width:thin;}" +
        ".nt-scrollbar::-webkit-scrollbar{block-size:8px;inline-size:8px;}" +
        ".nt-scrollbar::-webkit-scrollbar-track{background:transparent;}" +
        ".nt-scrollbar::-webkit-scrollbar-thumb{background:var(--tnt-color-primary-fixed);background-clip:content-box;border:2px solid transparent;border-radius:9999px;}";
