...
/// </summary>
public interface ITnTPopoverService {
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task BringToFrontAsync(ITnTPopoverHandle popover);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task HideAsync(ITnTPopoverHandle popover);

    /// <summary>
    ///     Opens a popover for a render fragment.
    /// </summary>
    /// <param name="renderFragment">The content to render inside the popover.</param>
    /// <param name="options">The popover options. When <see cref="TnTPopoverOptions.InstanceKey" /> is provided, an existing matching popover is reused.</param>
    /// <returns>The created or reused popover handle.</returns>
    Task<ITnTPopoverHandle> OpenAsync(RenderFragment renderFragment, TnTPopoverOptions? options = null);
    ...
    /// <returns>The created or reused popover handle.</returns>
    Task<ITnTPopoverHandle> OpenAsync<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TComponent>(TnTPopoverOptions? options = null, IReadOnlyDictionary<string, object?>? parameters = null) where TComponent : IComponent;
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task ShowAsync(ITnTPopoverHandle popover);
    ...
    /// <returns>A task representing the asynchronous operation.</returns>
    Task UpdatePositionAsync(ITnTPopoverHandle popover, double left, double top);
}
