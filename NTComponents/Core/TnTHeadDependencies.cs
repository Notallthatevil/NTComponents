...
public class TnTHeadDependencies : IComponent {
    ...
    private void Render(RenderTreeBuilder builder) {
        ...
        builder.AddAttribute(21, "href", "https://fonts.googleapis.com/css2?family=Material+Symbols+Sharp:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200");
        builder.CloseElement();

        // <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
        builder.OpenElement(22, "link");
        builder.AddAttribute(23, "rel", "stylesheet");
        builder.AddAttribute(24, "href", "https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200");
        builder.CloseElement();

        // <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
        builder.OpenElement(25, "link");
        builder.AddAttribute(26, "rel", "stylesheet");
        builder.AddAttribute(27, "href", "https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200");
        builder.CloseElement();
