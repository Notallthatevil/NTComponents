...
- Do not create component-local CSS custom properties for hardcoded sizes, spacing, typography, motion, or shape values. Use SCSS variables and existing `NTComponents/Styles/_Variables` tokens instead.
