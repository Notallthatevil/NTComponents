...
public enum TnTColor {
    ...
    /// <remarks>
    ///     <para>
    ///         Do use this when a component should inherit its default color mapping instead of opting into a specific semantic role. Do not use this when the component must intentionally communicate
    ///         a semantic color meaning.
    ///     </para>
    /// </remarks>
    None,
    ...
    /// </summary>
    /// <remarks>
    ///     <para>Do use this as a raw utility color only when a fixed literal black is intentionally required. Do not use it in place of semantic roles when theming and contrast adaptation matter.</para>
    /// </remarks>
    Black,
    ...
    /// </summary>
    /// <remarks>
    ///     <para>Do use this as a raw utility color only when a fixed literal white is intentionally required. Do not use it in place of semantic roles when theming and contrast adaptation matter.</para>
    /// </remarks>
    White,
